...
Skybox::Skybox(std::vector<std::string> faceLocations)
{
	...
	{
		stbi_uc *texData = stbi_load(faceLocations[i].c_str(), &width, &height, &bitDepth, 0);
		if(!texData)
		{
	...
	// OBS: No uv's defined since using directions from camera to sample cubemap
	//		No normals since not doing lighting for skybox
